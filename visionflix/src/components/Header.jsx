...
const Header = () => { 
    ...
    return (
        <div className='absolute z-10 flex w-full items-center justify-between px-6 bg-gradiant-to-b from-black'>
            ...
            <img className='w-56' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKCJzks3d-niwfXayY9OtjnLXS0fcZl8K9_A&s" alt="netflix-logo" />
{
                user && (
